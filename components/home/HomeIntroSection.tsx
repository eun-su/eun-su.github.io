...
const careerItems: CareerItem[] = [
  {
    title: "설계와 실행을 함께하는 방식",
    desc: "디자인 의도를 실제 서비스 화면으로 옮기고, 퍼블리싱과 프론트엔드 구현, 운영 대응까지 하나의 흐름으로 정리해 왔습니다.",
  },
  {
    title: "실무 중심 협업 경험",
    desc: "이커머스와 브랜드 사이트, 관리자 기능, 게시판·문의·결제 흐름까지 현업에서 바로 쓰이는 구조를 기준으로 작업했습니다.",
  },
  {
    title: "운영 이해 기반의 작업",
    desc: "보이는 화면만이 아니라 유지보수, 실무 전달, 실제 사용 흐름까지 고려하는 방식으로 일했습니다.",
  },
];

const projectItems: ProjectItem[] = [
  {
    title: "홈페이지 구축 및 리뉴얼 · 쇼핑몰 튜닝 및 운영 개선",
    desc: "브랜드/기업 사이트 신규 구축, 구조 개편, 화면 리뉴얼과 함께 카페24·고도몰·아임웹 환경의 기능 조정, 화면 개선, 운영 편의성 보완까지 진행했습니다.",
  },
  {
    title: "문의·게시판·결제 흐름 설계",
    desc: "입력-확인-응대-결제까지 이어지는 실제 사용 흐름 정리",
  },
  {
    title: "마케팅 실행과 분석 연결",
